            ...
            <View style={Styles.container}>
              ...
              <View style={Styles.digestcontain_view}>
                  ...
                  <View style={Styles.digestview_1}>
                    <TouchableOpacity activeOpacity={0.7} style={Styles.digest_contain}/>
                    <Text style={Styles.digestcontain_text}>베아제</Text>

                    <TouchableOpacity activeOpacity={0.7} style={Styles.digest_contain3}/>
                    <Text style={Styles.digestcontain_text}>베아제</Text>
                  </View>

                  <View style={Styles.digestview_2}>
                    <TouchableOpacity activeOpacity={0.7} style={Styles.digest_contain2}/>
                    <Text style={Styles.digestcontain_text}>베아제</Text>
                      
                    <TouchableOpacity activeOpacity={0.7} style={Styles.digest_contain4}/>
                    <Text style={Styles.digestcontain_text}>베아제</Text>
                  </View>
              </View>
            </View>
