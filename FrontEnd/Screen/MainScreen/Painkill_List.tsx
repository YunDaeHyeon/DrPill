    ...
    return (
        <>
            <View style={Styles.container}>
              ...
              <View style={Styles.painkillcontain_view}>

                  <View style={Styles.painkillview_1}>
                    <TouchableOpacity activeOpacity={0.7} style={Styles.painkill_contain}/>
                    <Text style={Styles.painkillcontain_text}>베아제</Text>

                    <TouchableOpacity activeOpacity={0.7} style={Styles.painkill_contain3}/>
                    <Text style={Styles.painkillcontain_text}>베아제</Text>
                  </View>

                  <View style={Styles.painkillview_2}>
                    <TouchableOpacity activeOpacity={0.7} style={Styles.painkill_contain2}/>
                    <Text style={Styles.painkillcontain_text}>베아제</Text>
                      
                    <TouchableOpacity activeOpacity={0.7} style={Styles.painkill_contain4}/>
                    <Text style={Styles.painkillcontain_text}>베아제</Text>
                  </View>
              </View>
            </View>
